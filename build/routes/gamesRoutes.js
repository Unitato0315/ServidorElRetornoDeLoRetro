...
class gamesRoutes {
    ...
    config() {
        ...
        this.router.get('/ultimafactura/', gamesControllers_1.default.ultimafactura);
        this.router.get('/pagos/', jwt_1.checkjwt, gamesControllers_1.default.getPagos);
        this.router.get('/envios/', jwt_1.checkjwt, gamesControllers_1.default.getEnvios);
        this.router.post('/facturas/', jwt_1.checkjwt, gamesControllers_1.default.crearFactura);
        this.router.post('/pedidos/', jwt_1.checkjwt, gamesControllers_1.default.crearPedido);
        this.router.get('/listafactura/:id', jwt_1.checkjwt, gamesControllers_1.default.obtenerPedidos);
        this.router.get('/listapedidos/', jwt_1.checkjwt, (0, rol_1.soloadmin)(), gamesControllers_1.default.obtenerAdminPedidos);
        this.router.get('/veridproductos/:id', jwt_1.checkjwt, gamesControllers_1.default.obtenerIdProductos);
        this.router.get('/obtenerunpedido/:id', jwt_1.checkjwt, gamesControllers_1.default.obtenerUnPedido);
