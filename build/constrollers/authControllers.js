            ...
            if (!(username && password)) {
                ...
                if (user.length < 1) {
                    ...
                    if (value) {
                        ...
                        const token = jsonwebtoken_1.default.sign({ ID_USUARIO: user[0].ID_USUARIO, USERNAME: user[0].USERNAME, ID_ROL: user[0].ID_ROL }, config_1.default.jwtSecret, { expiresIn: '30d' });
